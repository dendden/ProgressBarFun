...
//  ProgressBarFun
//
//  Created by Denys Triasunov on 11/4/16.
...
public class ProgressBarDraw : NSObject {
    ...
    public dynamic class func drawProgressBar(frame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 16), progress: CGFloat = 221) {
        //// General Declarations
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }

        //// Color Declarations
        let color = UIColor(red: 0.871, green: 0.372, blue: 0.372, alpha: 1.000)
